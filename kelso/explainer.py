...
max_ccs_id = ccs_data['ccs_id'].max()
...
print('='*5 + '  PATIENT 1  ' + '='*5)
print_patient(icd_codes[reference], counts[reference], ontology)
print('='*5 + '  PATIENT 2  ' + '='*5)
print_patient(icd_codes[best+first], counts[best+first], ontology)
